const translations = {
  zh: {
    ...
    "blog.title": "技术博客",
    "blog.stats.posts": "3 篇文章",
    "blog.stats.words": "约 6.5k 字",
    "blog.categories.aria": "博客分类",
    "blog.category.paper": "论文阅读",
    "blog.category.project": "项目分享",
    "blog.category.notes": "经验杂谈",
    "blog.authorAlt": "作者",
    "blog.authorName": "朱冠宇",
    "blog.post1.tag": "多模态 · 物理推理",
    "blog.post1.title": "PhysicsMind 项目复盘：从仿真到现实的物理推理评测",
    "blog.post1.excerpt":
      "在参与 PhysicsMind 项目的过程中，我们遇到了诸多 Sim-to-Real 的挑战。本文详细记录了如何构建配对数据集、设计评测指标，以及 VLMs 在物理推理任务上的表现分析。",
    "blog.post2.tag": "农业 AI · 多模态",
    "blog.post2.title": "Lychee-Bench：构建农业领域的过程级多模态推理基准",
    "blog.post2.excerpt":
      "分享我们在华南农业大学荔枝园采集数据、构建 Lychee-Bench 基准测试集的经验，从田间图像采集到 CoT 样本标注，再到 GRPO 对齐训练。",
    "blog.post3.tag": "科研经验 · 方法论",
    "blog.post3.title": "科研推进的三个节奏：读、做、复盘",
    "blog.post3.excerpt":
      "结合近两年的项目经历，总结一个可执行的科研节奏：快速读论文找问题、短周期实验拿反馈、系统复盘形成下一轮假设。",
    "blog.readMore": "阅读更多 →",
    "blog.back": "← 返回博客列表"
  },
  en: {
    ...
    "blog.stats.posts": "3 posts",
    "blog.stats.words": "about 6.5k words",
    "blog.categories.aria": "Blog categories",
    "blog.category.paper": "Paper Notes",
    "blog.category.project": "Project Notes",
    "blog.category.notes": "Notes",
    "blog.authorAlt": "Author",
    "blog.authorName": "Guanyu Zhu",
    "blog.post1.tag": "Multimodal · Physical Reasoning",
    "blog.post1.title": "PhysicsMind Retrospective: Evaluating Physical Reasoning from Simulation to Reality",
    "blog.post1.excerpt":
      "While working on PhysicsMind, we encountered multiple Sim-to-Real challenges. This post walks through paired dataset construction, evaluation design, and what VLMs reveal in physical reasoning tasks.",
    "blog.post2.tag": "Agricultural AI · Multimodal",
    "blog.post2.title": "Lychee-Bench: Building a Process-Level Multimodal Reasoning Benchmark for Agriculture",
    "blog.post2.excerpt":
      "This post summarizes our experience collecting data in lychee orchards at South China Agricultural University, from field image acquisition and CoT annotation to GRPO-based alignment training.",
    "blog.post3.tag": "Research Practice · Methodology",
    "blog.post3.title": "Three Rhythms of Research: Read, Build, Reflect",
    "blog.post3.excerpt":
      "Based on project experience from the past two years, this post distills a workable research rhythm: read fast, run short experiments, and turn retrospectives into the next round of hypotheses.",
